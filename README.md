...
**Javascript Chat App** — Professional JavaScript-Chat-App - Created by Gabriel Demetrios Lafis

Total source lines: **522** across **6** files in **3** languages.
...
Total de linhas de código: **522** em **6** arquivos em **3** linguagens.
